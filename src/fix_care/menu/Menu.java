...
public void setUsuario (Usuario usuario){
 ...
 init();
    ...
    private void init() { 
        ...
        add(scroll);
        // 
        System.out.println("YA TE ENTRO TODA ");
        addTitle("Bienvenido " +usuario.getUsuario() );
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DASHBOARD, "Dashboard"));
        addTitle("");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERSON_ADD, "USUARIO", "ALTA", "BAJA", "MODIFICACION"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.HOME, "DEPARTAMENTO", "ALTA", "BAJA", "MODIFCIACION"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ADD, "CREAR TICKET"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.SEARCH, "CONSULTA"));
